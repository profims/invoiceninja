...
Gdy przelewy zostaną zaksięgowane na Twoim koncie, wróć do tej strony i kliknij "Dokończ weryfikację" obok właściwego konta.',
    ...
    'invoice_not_related_to_payment' => 'Faktura nr :invoice nie jest związana z tą płatnością',
    'credit_not_related_to_payment' => 'Numer karty kredytowej :credit nie jest powiązany z tą płatnością',
    ...
    'notification_invoice_overdue_subject' => 'Faktura :invoice jest przeterminowana dla :client',
    'notification_invoice_overdue' => 'Poniższa faktura :invoice dla klienta :client i :amount jest już przeterminowana.',
    ...
    'peppol_credits_info' => 'Do wysyłania i odbierania faktur elektronicznych wymagane są e-kredyty. Są one naliczane za każdy dokument. Jeśli posiadasz już kredyty, kliknij Kontynuuj.',
    ...
    'of_budget' => 'budżetowy',
    'invoiced_hours' => 'Godziny fakturowane',
    'less' => 'Mniej',
    ...
    'downgrade_to_free_description' => 'Spowoduje to usunięcie wszystkich płatnych funkcji z Twojego konta.',
    ...
    'docuninja_grant_access_help' => 'Udziel użytkownikom Invoice Ninja dostępu do DocuNinja',
    ...
    'ses_topic_arn_help' => 'Temat SES (opcjonalny, tylko do śledzenia webhooków)',
    'ses_region_help' => 'Region AWS, czyli us-east-1',
    'ses_secret_key' => 'Klucz tajny SES',
    'ses_access_key' => 'Identyfikator klucza dostępu SES',
    'lifecycle' => 'Cykl życia',
    'order_columns' => 'Kolumny zamówień',
    'topic_arn' => 'Temat ARN',
    'lang_Catalan' => 'kataloński',
    'lang_Afrikaans' => 'Afrykanerski',
    'lang_Indonesian' => 'indonezyjski',
    'replaced' => 'Zastąpiony',
    'ses_from_address' => 'SES Od adresu',
    'ses_from_address_help' => 'Adres e-mail do wysyłki musi zostać zweryfikowany w AWS',
    'unauthorized_action' => 'Nie masz uprawnień do wykonania tej czynności',
    'einvoice_received_subject' => 'Otrzymano/otrzymano e-fakturę/y',
    'einvoice_received_body' => 'Otrzymałeś nową/e fakturę/y elektroniczną :count .<br><br> Zaloguj się, aby zobaczyć.',
    'download_files_too_large' => 'Niektóre pliki były zbyt duże, aby dołączyć je bezpośrednio do wiadomości e-mail. Skorzystaj z poniższych linków, aby pobrać je pojedynczo.',
    'restore_disabled_verifactu' => 'Nie można przywrócić faktury po jej usunięciu',
    'delete_disabled_verifactu' => 'Nie można usunąć faktury po jej anulowaniu lub modyfikacji',
    'rectify' => 'Prostownik',
    'verifactu_invoice_send_success' => 'Faktura :invoice dla :client została pomyślnie wysłana do AEAT',
    'verifactu_invoice_sent_failure' => 'Faktura :invoice dla :client nie została wysłana do AEAT :notes',
    'verifactu_cancellation_send_success' => 'Anulowanie faktury dla :invoice zostało pomyślnie wysłane do AEAT',
    'verifactu_cancellation_send_failure' => 'Anulowanie faktury dla :invoice nie powiodło się i nie udało się wysłać do AEAT :notes',
    'verifactu' => 'Verifactu',
    'justify' => 'Uzasadniać',
    'outdent' => 'Wcięcie',
    'indent' => 'Wciąć',
    ...
    'feedback_modal_description' => 'Chętnie poznamy Twoją opinię!',
    'do_not_ask_again' => 'Nie pytaj ponownie',
    'not_likely' => 'Mało prawdopodobne',
    'extremely_likely' => 'Bardzo prawdopodobne',
    'feedback_slider_title' => 'Jak duże jest prawdopodobieństwo, że polecisz Invoice Ninja znajomemu lub współpracownikowi?',
    'actual_delivery_date' => 'Rzeczywista data dostawy',
    'actual_delivery_date_help' => 'Czasami wymagane przy rozliczeniach międzynarodowych. Określa DOKŁADNĄ datę dostawy towarów.',
    'invoice_period' => 'Okres fakturowania',
    'invoice_period_help' => 'Określa okres czasu, w którym świadczone były usługi.',
    'paused_recurring_invoice_helper' => 'Uwaga! Przy ponownym wystawianiu faktury cyklicznej upewnij się, że data następnej wysyłki przypada w przyszłości.',
    'thank_you_for_feedback' => 'Dziękujemy za opinię!',
    'use_legacy_editor' => 'Użyj starszego edytora Wysiwyg',
    'use_legacy_editor_help' => 'Użyj edytora TinyMCE.',
    'enable_e_invoice_received_notification' => 'Włącz powiadomienie o otrzymaniu faktury elektronicznej',
    'enable_e_invoice_received_notification_help' => 'Otrzymaj powiadomienie e-mailem po otrzymaniu nowej faktury elektronicznej.',
    'price_changes' => 'Zmiany cen planów od 1 stycznia 2026 r.',
    'notification_quote_rejected_subject' => 'Cytat :quote został odrzucony przez :client',
    'notification_quote_rejected' => 'Następujący klient :client odrzucił ofertę :quote dla :amount :notes .',
    'activity_150' => 'Konto zostało usunięte :notes',
    'activity_151' => 'Klient :notes został połączony z :client przez :user',
    'activity_152' => 'Dostawca :notes został połączony z :vendor przez :user',
    'activity_153' => 'Klient :notes został usunięty przez :user',
    'activity_154' => 'Faktura elektroniczna :invoice dla :client została pomyślnie wysłana do AEAT',
    'activity_155' => 'Nie udało się wysłać faktury elektronicznej :invoice dla :client do AEAT :notes',
    'activity_156' => 'Anulowanie faktury dla :invoice zostało pomyślnie wysłane do AEAT',
    'activity_157' => 'Anulowanie faktury dla :invoice nie powiodło się i nie udało się wysłać do AEAT :notes',
    'activity_158' => 'Cytat :quote został odrzucony przez :client :notes',
    'quotes_with_status_sent_can_be_rejected' => 'Odrzucić można tylko oferty ze statusem „Wysłane”.',
    'reject' => 'Odrzucić',
    'rejected' => 'Odrzucony',
    'reject_quote' => 'Odrzuć ofertę',
    'reject_quote_confirmation' => 'Czy na pewno chcesz odrzucić tę ofertę?',
    'reason' => 'Powód',
    'enter_reason' => 'Podaj powód...',
    'notification_invoice_overdue_summary_subject' => 'Podsumowanie przeterminowanej faktury: :date',
    'notification_invoice_overdue_summary' => 'Następujące faktury są przeterminowane:',
    'purge_user_confirmation' => 'Uwaga! Ta czynność spowoduje ponowne przypisanie wszystkich jednostek do właściciela konta i trwałe usunięcie użytkownika ze wszystkich firm i kont. Czy na pewno chcesz kontynuować?',
    'peppol_sending_failed' => 'Wysyłanie faktury elektronicznej nie powiodło się!',
    'peppol_sending_success' => 'E-faktura została pomyślnie wysłana!',
    'auto_generate' => 'Automatyczne generowanie',
    'mollie_payment_pending' => 'Twoja płatność jest w trakcie realizacji. Poczekaj na jej przetworzenie. Wyślemy Ci e-mail po jej zrealizowaniu.',
    'over_payment_helper' => 'Opcjonalnie: możesz zapłacić więcej niż kwota tutaj pokazana (np. napiwek, zaokrąglony w górę).',
    'new_resource' => 'Nowy zasób',
    'drop_your_logo_here' => 'Upuść tutaj swoje logo lub kliknij, aby przeglądać',
    'save_to_enable_health_check' => 'Kontrola stanu będzie dostępna po zapisaniu zmian bramy.',
    'audit_log' => 'Dziennik audytu',
    'clone_to_template' => 'Klonuj do szablonu',
    'clone_document_description' => 'Klonuj do nowego dokumentu',
    'add_signatories' => 'Dodaj sygnatariuszy',
    'authorized_to_sign' => 'Upoważniony do podpisywania',
    'ninja_quote_notification' => 'Cytat Podpisane powiadomienie',
    'ninja_invoice_notification' => 'Powiadomienie o podpisaniu faktury',
    'ninja_credit_notification' => 'Powiadomienie o podpisaniu kredytu',
    'ninja_purchase_order_notification' => 'Powiadomienie o podpisaniu zamówienia',
    'email_client_when_quote_signed_description' => 'Klient poczty e-mail po podpisaniu oferty',
    'email_client_when_invoice_signed_description' => 'Klient poczty e-mail po podpisaniu faktury',
    'email_client_when_credit_signed_description' => 'Klient poczty e-mail po podpisaniu umowy kredytowej',
    'email_vendor_when_purchase_order_signed_description' => 'Wyślij e-mail do sprzedawcy po podpisaniu zamówienia zakupu',
    'custom_document_completed' => 'Ukończono dokument niestandardowy',
    'email_client_when_custom_document_completed' => 'Klient poczty e-mail po podpisaniu dokumentu niestandardowego',
    'sender' => 'Nadawca',
    ...
    'document_type_description' => 'Wybierz typ dokumentu, dla którego chcesz skonfigurować podpisy',
    'new_signatory' => 'Nowy sygnatariusz',
    'signatory' => 'Sygnatariusz',
    'invoice_ninja_template_description' => 'Dostosuj lokalizację podpisów w dokumentach Invoice Ninja, takich jak faktury, oferty itp.',
    'activity_159' => 'Faktura :invoice dla :client została podpisana',
    'activity_160' => 'Cytat :quote dla :client został podpisany',
    'activity_161' => 'Podpisano kredyt :credit dla :client',
    'activity_162' => 'Zamówienie zakupu :purchase_order na :vendor zostało podpisane',
    'activity_163' => 'Dokument niestandardowy: dokument dla :client został podpisany',
    'activity_164' => 'Synchronizacja QuickBooks nie powiodła się. :notes',
    'activity_165' => 'Synchronizacja QuickBooks pomyślna. :notes',
    'create_your_own' => 'Stwórz swój własny',
    'create_your_own_description' => 'Utwórz własny szablon, korzystając z własnego dokumentu PDF do przesłania',
    'new_template_description' => 'Aby rozpocząć, wybierz jeden z naszych gotowych szablonów, np. NDA, umowę sprzedaży itp.',
    'choose_template_type' => 'Wybierz typ szablonu, który chcesz utworzyć',
    'template' => 'Szablon',
    'templates' => 'Szablony',
    'new_template' => 'Nowy szablon',
    'user_limit_reached' => 'Potrzebujesz więcej użytkowników? Zmień swój plan na lepszy!',
    'requires_approval' => 'Wymaga zatwierdzenia',
    'document_viewed_notification' => 'Powiadomienia o wyświetlonych dokumentach',
    'document_created_notification' => 'Powiadomienia o utworzeniu dokumentu',
    'document_sent_notification' => 'Powiadomienia o wysłaniu dokumentów',
    'document_signed_notification' => 'Powiadomienia o podpisaniu dokumentu',
    'document_completed_notification' => 'Powiadomienia o ukończeniu dokumentu',
    'document_rejected_notification' => 'Powiadomienia o odrzuconych dokumentach',
    'document_voided_notification' => 'Powiadomienia o unieważnieniu dokumentów',
    'document_expired_notification' => 'Powiadomienia o wygaśnięciu dokumentów',
    'document_created' => 'Dokument utworzony',
    'template_loaded' => 'Szablon załadowany',
    'select_user_or_client' => 'Wybierz użytkownika lub klienta',
    'docuninja_quota_available_but_no_users' => 'Najpierw dodaj użytkownika do Invoice Ninja, a następnie przyznaj mu tutaj dostęp do DocuNinja',
    'send_confirmation' => 'Wyślij potwierdzenie',
    'document_queued_for_sending' => 'Dokument w kolejce do wysłania',
    'document_voided' => 'Dokument unieważniony',
    'view_document' => 'Wyświetl dokument',
    'make_template' => 'Utwórz szablon',
    'use_template' => 'Użyj szablonu',
    'map_signatories' => 'Sygnatariusze mapy',
    'map_signatories_instructions' => 'Przypisz sygnatariuszy do szablonu',
    'total_signatories' => 'Łączna liczba sygnatariuszy',
    'mapped' => 'Zmapowano',
    'docuninja_splash_message' => 'Ładowanie DocuNinja...',
    'docuninja_contact_admin_for_access' => 'Aby uzyskać dostęp do DocuNinja, skontaktuj się z administratorem.',
    'void' => 'Próżnia',
    'invitation_signatory_help' => 'Dokumenty podpisuje się sekwencyjnie; po złożeniu podpisu przez pierwszą osobę, następna osoba będzie mogła złożyć podpis.',
    'timeline' => 'Oś czasu',
    'cloned_document' => 'Dokument sklonowany',
    'voided_document' => 'Dokument unieważniony',
    'voided' => 'Unieważnione',
    'archive_document_description' => 'Czy na pewno chcesz zarchiwizować ten dokument?',
    'restore_document_description' => 'Czy na pewno chcesz przywrócić ten dokument?',
    'delete_document_description' => 'Czy na pewno chcesz usunąć ten dokument?',
    'document_archived' => 'Dokument zarchiwizowany',
    'document_restored' => 'Dokument przywrócony',
    'document_deleted' => 'Dokument usunięty',
    'sign_now' => 'Podpisz teraz',
    'signed_document' => 'Podpisany dokument',
    'tour_document_upload' => 'Aby rozpocząć podpisywanie, prześlij swój dokument tutaj. Przeciągnij i upuść pliki w tym obszarze.',
    'tour_signatory_selector' => 'To jest selektor sygnatariuszy. Użyj go, aby zarządzać sygnatariuszami swojego dokumentu. Wybierz sygnatariusza, aby kontynuować.',
    'tour_continue_select_signatory' => 'Kontynuuj wybierając sygnatariusza.',
    'tour_toolbox_description' => 'Po prawej stronie znajduje się skrzynka z narzędziami. Użyj jej, aby dodać pola i elementy, z którymi sygnatariusze będą mogli wchodzić w interakcję. Pole podpisu jest już wybrane. Kliknij, aby kontynuować.',
    'tour_document_canvas' => 'To jest płótno Twojego dokumentu. Umieść i rozmieść tutaj pola dla swoich sygnatariuszy.',
    'tour_save_document' => 'Po zakończeniu kliknij tutaj, aby zapisać dokument.',
    'create_signature' => 'Utwórz podpis',
    'signature_name' => 'Podpis Imię i nazwisko',
    'close_tab' => 'Zamknij kartę',
    'sign' => 'Podpisać',
    'add_open_exchange' => 'Dodaj klucz Open Exchange',
    'all_entity_types_created' => 'Utworzono wszystkie typy encji',
    'amount_must_be_greater_than_zero' => 'Kwota musi być większa od zera',
    'autobill_failure' => 'Automatyczne fakturowanie nie powiodło się',
    'autobill_success' => 'Automatyczne fakturowanie zakończone powodzeniem',
    'available' => 'Dostępny',
    'blueprint' => 'Plan',
    'capabilities' => 'Możliwości',
    'card_holder_help' => 'Imię i nazwisko posiadacza karty',
    'cards' => 'Karty',
    'charts' => 'Wykresy',
    'company_logo' => 'Logo firmy',
    'create_client_or_user' => 'Utwórz klienta lub użytkownika',
    'create_docuninja_account' => 'Utwórz konto DocuNinja',
    'create_recurring_expense' => 'Utwórz cykliczny wydatek',
    'create_recurring_invoice' => 'Utwórz fakturę cykliczną',
    'create_recurring_quote' => 'Utwórz cykliczną wycenę',
    'create_subscription' => 'Utwórz subskrypcję',
    'create_user' => 'Utwórz użytkownika',
    'created' => 'Stworzony',
    'creating' => 'Tworzenie',
    'credit_signed_notification' => 'Powiadomienie o podpisaniu kredytu',
    'customize_cards' => 'Dostosuj karty',
    'datatable' => 'Tabela danych',
    'date_must_be_after_previous_schedule' => 'Data musi być późniejsza niż poprzedni harmonogram',
    'default_checkbox_label' => 'Domyślne pole wyboru',
    'default_multiselect_label' => 'Domyślny wybór wielokrotny',
    'default_radio_group_label' => 'Domyślna grupa radiowa',
    'default_select_label' => 'Domyślny wybór',
    ...
    'disable_docuninja' => 'Wyłącz DocuNinja',
    'document_not_found' => 'Nie znaleziono dokumentu',
    'docuninja_access_grant_failed' => '',
    'docuninja_access_granted_successfully' => 'Dostęp do DocuNinja został przyznany pomyślnie',
    'download_signed_document' => 'Pobierz podpisany dokument',
    'e_expense_created' => 'Utworzono e-wydatki',
    'edit_rule' => 'Edytuj regułę',
    'einvoice_delivery_failure' => 'Nie udało się dostarczyć faktury elektronicznej',
    'einvoice_delivery_success' => 'Sukces w dostarczaniu faktury elektronicznej',
    'einvoice_sent' => 'E-faktura wysłana',
    'element' => 'Element',
    'email_invoice_failed' => 'Nie udało się wysłać wiadomości e-mail',
    'empty_checkbox_label' => 'Puste pole wyboru',
    'end_of_month' => 'Koniec miesiąca',
    'error_fetching_pricing' => 'Błąd podczas pobierania cen',
    'exchange_rate_not_enabled' => 'Kurs wymiany nie jest włączony',
    'failed_payment' => 'Płatność nie powiodła się',
    'field_is_required' => 'Pole jest wymagane',
    'generate' => 'Spowodować',
    'google_drive' => 'Dysk Google',
    'initials' => 'Inicjały',
    'initials_description' => 'Opis inicjałów',
    'invalid_state' => 'Nieprawidłowy stan',
    'invoice_signed_notification' => 'Powiadomienie o podpisaniu faktury',
    'link_copied' => 'Link skopiowany',
    'make_template_description' => 'Utwórz własny szablon, korzystając z własnego dokumentu PDF do przesłania',
    'manage' => 'Zarządzać',
    'multiselect_needs_two_options' => 'Wybór wielokrotny wymaga dwóch opcji',
    'no_cards_selected' => 'Nie wybrano żadnych kart',
    'no_templates_found' => 'Nie znaleziono szablonów',
    'nordigen' => 'Nordigen',
    'pages' => 'Strony',
    'passed' => 'Przeszedł',
    'payment_emailed' => 'Płatność wysłana e-mailem',
    'payment_successful' => 'Płatność pomyślna',
    'pdf_password_required' => 'Wymagane hasło PDF',
    'pending_approval' => 'Oczekuje na zatwierdzenie',
    'please_select_at_least_one_user' => 'Proszę wybrać co najmniej jednego użytkownika',
    'please_select_plan' => 'Proszę wybrać plan',
    'please_select_signer' => 'Proszę wybrać sygnatariusza',
    'proformal_invoices' => 'Faktury proforma',
    'purchase_order_signed_notification' => 'Powiadomienie o podpisaniu zamówienia',
    'queue' => 'Kolejka',
    'quote_field' => 'Pole cytatu',
    'quote_signed_notification' => 'Cytat podpisane powiadomienie',
    'radio_needs_two_options' => 'Radio potrzebuje dwóch opcji',
    'recipient' => 'Odbiorca',
    ...
    'save_to_add_locations' => 'Zapisz, aby dodać lokalizacje',
    'saving' => 'Oszczędność',
    'select_design' => 'Wybierz projekt',
    'select_needs_two_options' => 'Wybierz dwie opcje',
    'sending' => 'Przesyłka',
    'setting_up' => 'Konfiguracja',
    'setup_company' => 'Załóż firmę',
    'signature-placeholder' => 'Symbol zastępczy podpisu',
    'signature:font-updated' => 'Zaktualizowano czcionkę podpisu',
    'signature_description' => 'Opis podpisu',
    'snappdf_not_enabled' => 'Snappdf nie jest włączony',
    'start_signing' => 'Zacznij podpisywać',
    'successfully_signed_document' => 'Pomyślnie podpisano dokument',
    'swap_signatory' => 'Sygnatariusz swapu',
    'template_details' => 'Szczegóły szablonu',
    'tips_and_notes' => 'Wskazówki i uwagi',
    'too_many_files' => 'Zbyt wiele plików',
    'type_signature' => 'Wpisz podpis',
    'untitled_document' => 'Dokument bez tytułu',
    'untitled_template' => 'Szablon bez tytułu',
    'update_recurring_expense' => 'Aktualizacja wydatków cyklicznych',
    'update_recurring_invoice' => 'Zaktualizuj fakturę cykliczną',
    'update_recurring_quote' => 'Zaktualizuj ofertę cykliczną',
    'update_subscription' => 'Aktualizuj subskrypcję',
    'update_user' => 'Aktualizuj użytkownika',
    'upgrade_account_message' => 'Komunikat o aktualizacji konta',
    'upgrade_now' => 'Zaktualizuj teraz',
    'upgrade_plan_docuninja' => 'Uaktualnij swój plan, aby włączyć DocuNinja',
    'use_signature' => 'Użyj podpisu',
    'use_snappdf' => 'Użyj SnapPDF',
    'user_note' => 'Notatka użytkownika',
    'vendor_notification_email' => 'E-mail z powiadomieniem dostawcy',
    'void_document_description' => 'Pusty opis dokumentu',
    'voided_payment' => 'Płatność anulowana',
    'welcome_to_docuninja' => 'Witamy w DocuNinja',
    'yodlee' => 'Yodlee',
    'location_name' => 'Nazwa lokalizacji',
    'quote_rejected' => 'Cytat odrzucony',
    'e_invoice_received_notification' => 'Powiadomienie o otrzymaniu faktury elektronicznej',
    'e_invoice_received_notification_help' => 'Wyślij e-mail po otrzymaniu faktury elektronicznej',
    'location_field' => 'Pole lokalizacji',
    ...
    'sync_direction_none_help' => 'Invoice Ninja will not sync any data to or from QuickBooks.',
    'sync_direction_pull_help' => 'Invoice Ninja will pull data from QuickBooks.',
    'sync_direction_push_help' => 'Invoice Ninja will push data to QuickBooks.',
    'sync_direction_bidirectional_help' => 'Invoice Ninja will both pull and pull data to QuickBooks.',
    'sync_settings' => 'Sync Settings',
    'realm_id' => 'QB Realm ID',
    'default_income_account' => 'Default Income Account',
    'automatic_taxes' => 'Automatic Taxes',
    'automatic_taxes_help' => 'When Automatic Taxes (AST) are enabled in Quickbooks, Invoice Ninja will first create the invoice in Quickbooks, and then pull the fully formed invoice back to Invoice Ninja.',
    'pull' => 'Pull',
    'push' => 'Push',
